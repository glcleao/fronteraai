...
const MessageSection = () => {
  ...
  return <section id="demonstracao" className="py-20 bg-gradient-to-b from-primary/5 via-background/50 to-background">
        ...
        <div className="max-w-2xl mx-auto">
          ...
          <div className="bg-gradient-to-b from-card to-muted/30 rounded-3xl p-4 shadow-premium border border-border/50">
            <div className="bg-background rounded-2xl p-6 min-h-[600px]">
              ...
              {/* Typing Indicator */}
              {visibleMessages < messages.length && visibleMessages > 0 && <div className="flex justify-start mt-4">
